...
export const DEFENSE_WHITE_ITEMS: MobaItem[] = [
...

	{
		...
		recipe: [MobaItemId.BLOODSOUL, MobaItemId.BLOODSOUL],
...

	{
		...
		recipe: [MobaItemId.BLOODSOUL, MobaItemId.FAIRYTALE_HAT],
...

	{
		...
		recipe: [MobaItemId.LINEN_CLOTH, MobaItemId.CHAOS_ICE],
...

	{
		...
		recipe: [MobaItemId.LINEN_CLOTH, MobaItemId.LINEN_CLOTH],
