...
export const PHYSICAL_GREEN_ITEMS: MobaItem[] = [
	{
		...
		recipe: [MobaItemId.IRON_HALBERD, MobaItemId.RUSTED_SWORD],
...

	{
		...
		recipe: [MobaItemId.SWORD_OF_JUSTICE, MobaItemId.RUSTED_SWORD],
...

	{
		...
		recipe: [MobaItemId.SKYRAZER_BROADSWORD, MobaItemId.SICKLE],
...

	{
		...
		recipe: [MobaItemId.CLEAVER, MobaItemId.IRON_HALBERD],
...

	{
		...
		recipe: [MobaItemId.SKYRAZER_BROADSWORD, MobaItemId.SKYRAZER_BROADSWORD],
...

	{
		...
		recipe: [MobaItemId.DAGGERS_OF_FRENZY, MobaItemId.DAGGERS],
