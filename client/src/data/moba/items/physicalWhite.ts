...
export const PHYSICAL_WHITE_ITEMS: MobaItem[] = [
...

	{
		...
		recipe: [MobaItemId.RUSTED_SWORD],
...

	{
		...
		recipe: [MobaItemId.RUSTED_SWORD, MobaItemId.BLOODSOUL],
...

	{
		...
		recipe: [MobaItemId.DAGGERS, MobaItemId.GLOVES],
...

	{
		...
		recipe: [MobaItemId.RUSTED_SWORD, MobaItemId.RUSTED_SWORD],
...

	{
		...
		recipe: [MobaItemId.DAGGERS, MobaItemId.DAGGERS],
