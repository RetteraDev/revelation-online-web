...
export const MAGICAL_WHITE_ITEMS: MobaItem[] = [
...

	{
		...
		recipe: [MobaItemId.TEXTS, MobaItemId.LAMBENT_CODEX],
...

	{
		...
		recipe: [MobaItemId.CHAOS_ICE, MobaItemId.BLOODSOUL],
...

	{
		...
		recipe: [MobaItemId.TEXTS, MobaItemId.BLOODSOUL],
...

	{
		...
		recipe: [MobaItemId.JADE_PENDANT, MobaItemId.BLOODSOUL],
